...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product border-0">
      <div>
    <img class="product-image" src=${product.image}></img>
      </div>
      <h3>${product.title}</h3>
      <p>Category: ${product.category}</p>
      <div class="container d-flex mb-2"><div class="col-6"><i class="fas fa-user text-warning"></i> ${product.rating.count}</div><div class="col-6"><i class="fas fa-star text-warning"></i> ${product.rating.rate}</div></div>
